...
[Professional closing]`,
  ...
  PROPOSAL_IMPROVEMENT: {
    instruction: `Improve the provided proposal by enhancing clarity and alignment with tender requirements. Use ONLY the provided context.

IMPROVEMENTS TO MAKE:
1. Strengthen executive summary
2. Better align with tender requirements
3. Improve professional language
4. Enhance technical approach
5. Ensure compliance section is complete

OUTPUT FORMAT:
Return the improved proposal content maintaining the original structure.`,
    
    examples: {
      good: "Enhanced content that better highlights company strengths while staying factual",
      bad: "Added invented details or generic improvements"
    }
  }
};
