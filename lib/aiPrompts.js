...
[Professional closing]`,
  ...
  PROPOSAL_IMPROVEMENT: {
    instruction: `LANGUAGE DETECTION AND PRESERVATION:
First, detect the language of the CURRENT PROPOSAL CONTENT:
- If the content is primarily in English, generate the improved content in English
- If the content is primarily in Bahasa Malaysia/Malay, generate the improved content in Bahasa Malaysia
- Maintain the same language throughout the improved content
...
INSIGHTS LANGUAGE:
- Always generate insights (both "change" and "explanation" fields) in Bahasa Malaysia
- The insights will be translated to English on the frontend for user display

OUTPUT FORMAT:
{
  "improvedContent": "[Full improved proposal text in the SAME LANGUAGE as the input content]",
  "insights": [
    {
  ...
  "insights": [
    {
      ...
      "explanation": "Ringkasan eksekutif yang lebih kuat akan memberikan kesan pertama yang baik kepada panel penilai"
    }
  ]
}
  ...
  "insights": [
    {
      ...
      bad: "Always changing language regardless of input, or mixing languages in the improved content"
    }
  }
};
